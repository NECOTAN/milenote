...
export default function Sidebar() {
    ...
    return (
        ...
        <aside className="hidden md:flex flex-col w-64 h-screen sticky top-0 bg-slate-50 p-6 z-10">
            <div className="mb-12 px-2 pt-2">
                <h1 className="text-3xl font-black tracking-widest text-slate-900">Milenote</h1>
            </div>
                    ...
                    return (
                        <Link
                            ...
                            className={`flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all ${isActive
                                    ? "bg-white shadow-[0_2px_10px_rgba(0,0,0,0.04)] text-slate-900 font-bold" // アクティブ時は白背景とドロップシャドウで強調表示
            ...
            <div className="mt-auto pt-8 border-t border-slate-200/50">
                <button
                    ...
                    className="flex w-full items-center gap-4 px-4 py-3.5 rounded-xl transition-all text-slate-500 hover:bg-red-50 hover:text-red-600 font-medium"
                >
                    <LogOut size={20} />
